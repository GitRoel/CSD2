...
samples = [sa.WaveObject.from_wave_file("audio_files/Dog2.wav"), sa.WaveObject.from_wave_file("audio_files/pop.wav")]
...
# create a list with the random sequence-numbers
for number in timestamps16th:
    sequence = random.randint(0, 1)
    lijst.append(sequence)
    print(sequence)
print(lijst)
